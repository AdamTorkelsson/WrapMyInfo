...
The API calls are created to be simplistic but still powerful. It is built to have the functions of SCRUD (search, create, read, update and delete). This API is still heavily under development and therefore much will change during the development. Use this versions more to see if it is something that could interest you as a developer or user.    
